...
class Config:
    ...
    CW_MQTT_GATEWAY_SERVICE = config['CW_MQTT_GATEWAY']['Service']
    ...
    CW_MQTT_GATEWAY_SERVICE = os.getenv('CW_MQTT_GATEWAY_SERVICE', CW_MQTT_GATEWAY_SERVICE)
    CW_MQTT_GATEWAY = os.getenv('CW_MQTT_GATEWAY', CW_MQTT_GATEWAY)
    CW_MQTT_GATEWAY_IP = os.getenv('CW_MQTT_GATEWAY_IP', CW_MQTT_GATEWAY_IP)
    CW_MQTT_GATEWAY_PORT = os.getenv('CW_MQTT_GATEWAY_PORT', CW_MQTT_GATEWAY_PORT)
